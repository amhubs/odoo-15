...
class ResConfigSettings(models.TransientModel):
    ...
    unicoding_marketplace_type = fields.Selection([
        ('ecwid', 'Ecwid'),
        ('opencart', 'Opencart'),
    ], string='Connector type', related='unicoding_marketplace_id.type', readonly=False)
    ...
    unicoding_marketplace_allow_update_price_oc = fields.Boolean(string="Update product price in Ecwid",
    ...
    unicoding_marketplace_page_products_num = fields.Integer(string="Products Per Page", default=50, related='unicoding_marketplace_id.page_products_num', readonly=False)
    unicoding_marketplace_page_orders_num = fields.Integer(string="Orders Per Page", default=100, related='unicoding_marketplace_id.page_orders_num', readonly=False)